        ...
        public CustomListCell() {
            ...
            tenantPropertyInfo.setOnAction(new EventHandler() {
                ...
                public void handle(Event arg0) {
                    ...
                    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../../resources/fxml/propertyowner/propertyOwnerPropertyListingDetailScene.fxml"));
                    Parent root = fxmlLoader.load();
                    propertyOwnerPropertyListingDetailsController controller = fxmlLoader.getController();
                    controller.initUserObejct(owner);
